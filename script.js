...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('siriOrbVisual').style.display = 'none';
  document.getElementById('siriCommand').style.display = 'none';
  document.getElementById('staticMessage').style.display = 'none';

  // Show Siri orb after 2s
  setTimeout(() => {
    document.getElementById('siriOrbVisual').style.display = 'flex';
  }, 2000);

  // Show "Hey Siri..." after 4s
  setTimeout(() => {
    document.getElementById('siriCommand').style.display = 'block';
  }, 4000);
